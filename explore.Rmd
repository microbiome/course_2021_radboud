...
Let's replace those taxonomic classes with official rank names. 

(Is there easier way to do this? AgglomerateByRank needs official rank names, 
should unofficial names be allowed...)############################################## NOTE
...
tse_firmicutes <- tse_phylum["Phylum:D_1__Firmicutes"]

# Gets the abundance table
abundance_firmicutes <- assay(tse_firmicutes, "counts")

# Calculates the density. Bandwidth can be adjusted; here, it is 20,000.
# density() is from stats package
density_firmicutes <- density(abundance_firmicutes, bw = 20000)
