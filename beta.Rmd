...
#tse_dmn <- runDMN(tse, name = "DMN", k = 1:7); saveRDS(tse_dmn, file = "tse_dmn.Rds")
tse_dmn <- readRDS("data/tse_dmn.Rds")
...
# grouping. 
#dmn_group <- calculateDMNgroup(tse_dmn, variable = "Genotype", 
