...
files to a _TreeSummarizedExperiment_ object. TSE object is a standard data structure 
...
`assays` slot includes a list of abundance tables. Imported abundance table is named as "counts".
Let us just use first cols and rows.
...
Now `colData` includes a sample metadata. Use kable to print it more nicely.
