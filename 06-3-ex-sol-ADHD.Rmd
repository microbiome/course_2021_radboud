...
```{r}
sub_cohort_1 <- subsetSamples(tse, colData(tse)$cohort=="Cohort_1")
sub_cohort_1_ADHD <- subsetSamples(sub_cohort_1, colData(sub_cohort_1)$patient_status=="ADHD")
