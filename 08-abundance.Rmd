...
Let's first agglomerate the data at the Genus level.
...
# There two groups "ADHD" and "control". Let's include that to the data frame.
...
Now we start with the Wilcoxon test. We test all the taxa by looping through columns,
...
# to use the same labels everywhere. 
