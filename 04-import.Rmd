...
-   [Bioconductor curatedMetagenomicData](https://bioconductor.org/packages/release/data/experiment/html/curatedMetagenomicData.html)

-   [Bioconductor ExperimentHub](https://bioconductor.org/packages/release/bioc/html/ExperimentHub.html)
