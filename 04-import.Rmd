...
Example code for import the first data set is available: [import.Rmd](import.Rmd)


Here, we just load pre-computed versions for these data sets.

```{r}
# Read pre-built data objects into the session
