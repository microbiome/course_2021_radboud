...
\CommentTok{\# density\_firmicutes \textless{}{-} density(abundance\_firmicutes, bw = 0.065)}
\CommentTok{\# }
\CommentTok{\# \# Plots the density}
\CommentTok{\# plot(density\_firmicutes,}
\CommentTok{\#      xlab="Relative abundance",}
\CommentTok{\#      ylab="Density",}
\CommentTok{\#      main=paste0("Firmicutes (",density\_firmicutes$n, " obs, ", }
\CommentTok{\#      density\_firmicutes$bw, " bw)"))}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{cat}\NormalTok{(}\FunctionTok{paste0}\NormalTok{(}\StringTok{"Different different cohorts and variance of abundance}
...
\begin{verbatim}
## Different different cohorts and variance of abundance
##            between samples, p-value: 0.739
\end{verbatim}
