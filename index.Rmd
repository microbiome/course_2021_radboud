...
R/Bioconductor framework for microbiome data science. It extends the capabilities of another popular framework,
...
**Citation** "Introduction to microbiome data science (2021). 
`r paste(authors, sep = ",")` URL: https://microbiome.github.io".
