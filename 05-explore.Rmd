...
contains. As we can see, there are `r dim(tse)[1]` taxa and `r
dim(tse)[2]` samples.
...
Next, try to explore some of the following questions on your own by
following examples in the [online
book](https://microbiome.github.io/OMA/). Prepare a reproducible
report (with Rmarkdown), and include the code that you use to import
the data and generate the analyses.
